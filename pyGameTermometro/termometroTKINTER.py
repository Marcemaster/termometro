...
class mainApp(Tk):
    ...
    def createLayuout(self):
        ...
        self.rb1 = ttk.Radiobutton(self, text="Fahrenheit", variable=self.tipoUnidad, value='F', command=self.selected).place(x=20, y=65)
        self.rb2 = ttk.Radiobutton(self, text="Celsius", variable=self.tipoUnidad, value='C', command=self.selected).place(x=20, y=85)
