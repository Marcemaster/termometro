...
class Termometro():
    def __init__(self):
        self.custome = pygame.image.load("termo1.png")
...
class Selector():
    ...
    def __init__(self, unidad = 'C'):
        self.__customes = []
        self.__customes.append(pygame.image.load("posiF.png"))
        self.__customes.append(pygame.image.load("posiC.png"))
...
class NumberInput():
    ...
    def on_event(self, event):
        if event.type == KEYDOWN:
            if event.unicode.isdigit() and len(self.__strValue) <= 11 or (event.unicode == '.' and self.__pointsCount == 0):
